...
6. **Maintainability** -- Use the Page Object Model (POM) to encapsulate page interactions and selectors. This reduces duplication and makes updates easier.
7. Use **Playwright MCP** to navigate to the app pages involved in your test
...
11. Never guess selectors — verify via Playwright MCP browser or source code
